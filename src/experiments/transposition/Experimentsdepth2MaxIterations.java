package experiments.transposition;

import AMSPlayground.*;
import AMSPlayground.legacy.AMS_Play_TT;
import Group12.Group12AI;
import game.Game;
import game.types.state.GameType;
import main.collections.FastArrayList;
import mcts.*;
import mcts.legacy.MCTS_NST_Tim;
import util.*;
 ...
 */
public class Experimentsdepth2MaxIterations {
...
//        mctsPlayers.add(new AMS_Tim_Tuned());
        ...
        amsPlayers.add(new AMS_Play_TT());
//        amsPlayers.add(new MCTS_MAST_Tuned());
//        amsPlayers.add(new MCTS_NSTv2_Tuned());
